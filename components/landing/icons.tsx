  ...
  return (
    <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
      <defs>
        ...
        <symbol id="ic-check" viewBox="0 0 64 64"><path d="M14 33l12 12 24-26" fill="none" stroke="currentColor" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round"/></symbol>
        <symbol id="ic-lock" viewBox="0 0 64 64"><rect x="12" y="28" width="40" height="28" rx="7" fill="none" stroke="currentColor" strokeWidth="4"/><path d="M21 28v-7a11 11 0 0122 0v7" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/><circle cx="32" cy="42" r="4" fill="currentColor"/></symbol>
