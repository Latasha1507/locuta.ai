...
description: >
  ...
  everything, the sun-bleached cream canvas, the nine-color candy palette, Geist + Space
...
typography:
  # — reading ramp (Geist) —
  body:      { fontFamily: "Geist", cqw: 0.85, weight: 400, lineHeight: 1.6 }
  subtitle:  { fontFamily: "Geist", cqw: 0.95, weight: 400, tracking: "0.18em", upper: true }
  pill-text: { fontFamily: "Geist", cqw: 0.75, weight: 600, tracking: "0.12em", upper: true }
  label:     { fontFamily: "Geist", px: 14, weight: 500, tracking: "0.1em", upper: true }
  # — display / hero ramp (Baloo 2 — brand rounded display, ink, sentence case) —
  card-headline:{ fontFamily: "Baloo 2", cqw: 1.9, weight: 700, lineHeight: 1.1 }
  orbit-numeral:{ fontFamily: "Baloo 2", cqw: 2.6, weight: 700, lineHeight: 1.0 }
  quote-display:{ fontFamily: "Baloo 2", cqw: 4.2, weight: 600, lineHeight: 1.3, tracking: "-0.01em" }
  stat-number: { fontFamily: "Baloo 2", cqw: 3.6, weight: 800, lineHeight: 1.0, tracking: "-0.03em" }
  section-headline:{ fontFamily: "Baloo 2", cqw: 4.0, weight: 700, lineHeight: 1.05, tracking: "-0.01em" }
  headline:    { fontFamily: "Baloo 2", cqw: 5.0, weight: 700, lineHeight: 1.05, tracking: "-0.02em" }
  closing-display:{ fontFamily: "Baloo 2", cqw: 8.5, weight: 800, lineHeight: 0.95, tracking: "-0.03em" }
  display:     { fontFamily: "Baloo 2", cqw: 12.0, weight: 800, lineHeight: 0.88, tracking: "-0.03em" }
...
components:
  ...
  pill-card:
    ...
    description: "Holds a circular card-icon, Bodoni headline, Geist body."
  stat-pill:
    backgroundColor: "{colors.white}"
    border: "0.2cqw solid {colors.outline}"
    rounded: "2rem"
...
The voice is a two-face conversation: **Geist** (didone serif, weight 700–800, always ink,
always sentence case) carries every headline, stat, and quote; **Geist** carries body and
...
- **Geist** display (ink, sentence case) + **Geist** body/pills (uppercase, tracked).
...
Two ramps. The **reading ramp** (Geist body 0.85cqw, uppercase tracked pill/label text)
...
- **Bodoni 700+ in ink, sentence case** (italic via `<em>` only, color allowed on the italic key word as a candy hue); **Geist pills/labels uppercase, 0.08em+ tracked**; negative-track Bodoni display.
...
- **Geist + Geist via Google Fonts.** CJK pairing (ZCOOL XiaoWei / Yozai) carries over from the source.
