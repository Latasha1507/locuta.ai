...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: "Can I use Locuta.ai to prepare for specific events?", a: "Absolutely! Many users practice for workplace communication, presentations, investor pitches, and important meetings. You can record your actual content and get AI feedback to refine your delivery before the real event." },
