            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {categoryStats.map((category: any) => (
                  ...
                  >
                    {/* Enhanced Gradient Border Card */}
                    <div className="relative rounded-2xl overflow-hidden group-hover:scale-[1.02] transition-all duration-300 category-card">
                      {/* Gradient border effect */}
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-400 via-indigo-500 to-blue-500 opacity-60 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"></div>
                      
                      {/* Inner card with padding for border effect */}
                      <div className="relative m-[3px] bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                        {/* Gradient overlay on hover */}
                        <div className="absolute inset-0 bg-gradient-to-br from-purple-50/50 via-indigo-50/30 to-blue-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
                        
                        {/* Content */}
                        <div className="relative p-6">
                          {/* Header with Icon */}
                          <div className="flex items-start justify-between mb-4">
                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-200 to-indigo-200 flex items-center justify-center shadow-md group-hover:shadow-xl transition-all duration-300 icon-container">
                              <span className="text-3xl category-icon">{category.icon}</span>
                            </div>
                            {category.completionPercentage > 0 && (
                              <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-sm font-bold text-white shadow-md">
                          ...
                          {/* Title & Description */}
                          <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:bg-gradient-to-r group-hover:from-purple-700 group-hover:to-indigo-700 group-hover:bg-clip-text group-hover:text-transparent transition-all">
                            {category.name}
                          </h3>
                          ...
                          {/* Progress Bar */}
                          <div className="mb-4">
                            <div className="w-full h-2.5 bg-slate-200/70 rounded-full overflow-hidden shadow-inner">
                              <div
                                className="h-full bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 rounded-full transition-all duration-700 shadow-sm"
